...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    private  Typeface TAB_VIEW_TEXT_STYLE = Typeface.DEFAULT_BOLD;
    ...
    private void populateTabStrip() {
       // final HomePagerAdapter adapter = (HomePagerAdapter) mViewPager.getAdapter();
        ...
        if (tabTitleView == null && TextView.class.isInstance(tabView)) {
            ...
            tabIconView.setImageDrawable(getResources().getDrawable(Integer.parseInt(adapter.getPageTitle(i).toString())));
